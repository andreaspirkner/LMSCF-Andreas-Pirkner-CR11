            ...
            "<div class='card card1 border-dark'>
                <div class='card-body'>
                   <img class='card-img-top border border-dark' src=".$row['img']." alt='Card image cap'>
                                ...
                                <img class='card-img-top border border-dark' src=".$row['loc_img']." alt='Card image cap'>
                                <hr>
                                <h6 class='card-text'>Address:</h6><p>" .$row['address']."</p>
                                <h6 class='card-text'>Zip Code:</h6><p>" .$row['zip']."</p>
                                <hr>
