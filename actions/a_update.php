...
if ($_POST) {
   ...
   $sql = "UPDATE animals SET img = '$img',name = '$name',description = '$description',availability = '$avail',island = '$island',loc_img = '$locimage',loc_name = '$locname',address = '$addr',zip = '$zip',size = '$size',age = '$age',hobbies = '$hob' WHERE id = {$id}" ;
   if($conn->query($sql) === TRUE) {
       ...
       echo  "<a href='../admin.php'><button class='btn btn-dark' type='button'>Admin</button></a>";
   } else {
