...
<div class="parallax_section2 parallax_image">
  <div class="row">
        ...
        <div class="card border-dark">
           ...
           <h2> Hi <?php echo $userRow['userName' ]; ?>, take a look at our animals!</h2>
            ...
            "<div class='card card1 border-dark'>
                <div class='card-body'>
                   <img class='card-img-top border border-dark' src=".$row['img']." alt='Card image cap'>
                                ...
                                <h6 class='card-text'>Age:</h6><p>" .$row['age']."</p>
                                <h6 class='card-text'>Hobbies:</h6><p>" .$row['hobbies']."</p>
                                <hr>
                                <h6>Klick More to show detailed information of this animal.</h6>
                                <a href='details.php?id=" .$row['id']."'><button class='btn btn-warning border border-dark' type='button'>More</button></a><hr>
                                <h6>Or Klick and adopt straight away.</h6>
                                <a href='adopt.php?id=" .$row['id']."'><button class='btn btn-success border border-dark' type='button'>Adopt</button></a>
                </div><!--END BODY-->
            </div><!--END CARS-->";
            }
                     } else  {
